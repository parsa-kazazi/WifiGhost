...
required_tools = ["aircrack-ng", "aireplay-ng", "reaver", "pixiewps", "airmon-ng", "iw", "iwconfig"]
not_found_tools = 0
...
if not_found_tools == 1:
    print("\n1 tool not found. script can't continue.\n")
    exit()
elif not_found_tools > 1:
    print("\n" + str(not_found_tools) + " tools not found. script can't continue.\n")
    exit()
else:
